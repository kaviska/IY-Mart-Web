...
export default function BestSellersCard({BestSellerProduct}:BaseSelectPropsType) {
    return (
        <div className="md:w-1/4 w-full flex flex-col md:justify-start justify-center md:gap-2 gap-1 md:shadow-none shadow-lg  sm:min-h-[400px]">
            <img src={`${process.env.NEXT_PUBLIC_SERVER_URL}/${BestSellerProduct.imageUrl}`} alt='kottu-image' className='  md:w-60 md:h-60 h-100 object-cover'/>
